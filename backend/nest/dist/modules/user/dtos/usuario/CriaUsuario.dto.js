...
const telefoneBrasil_decorator_1 = require("../../decorator/telefoneBrasil.decorator");
const upperCase_decorator_1 = require("../../decorator/upperCase.decorator");
const lowerCase_decorator_1 = require("../../decorator/lowerCase.decorator");
...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'O CPF não pode ser vazio' }),
    (0, class_validator_1.IsString)({ message: 'o CPF deve ser uma string' }),
    (0, isCPF_decorator_1.IsCPF)({ message: 'CPF inválido' }),
...
__decorate([
    (0, lowerCase_decorator_1.ContainsLowercase)(2, { message: 'A senha deve ter 2 letras minúsculas no mínimo' }),
    (0, upperCase_decorator_1.ContainsUppercase)(2, { message: 'A senha deve ter 2 letras maiúsculas no mínimo' }),
...
__decorate([
    (0, telefoneBrasil_decorator_1.IsTelefone)({ message: 'O telefone informado é inválido' }),
