...
/// <reference types="stripe/types/ThinEvent" />
...
/// <reference types="stripe/types/Billing/AlertsResource" />
/// <reference types="stripe/types/Billing/CreditBalanceSummaryResource" />
/// <reference types="stripe/types/Billing/CreditBalanceTransactionsResource" />
/// <reference types="stripe/types/Billing/CreditGrantsResource" />
...
/// <reference types="stripe/types/InvoiceRenderingTemplatesResource" />
...
/// <reference types="stripe/types/V2/Billing/MeterEventAdjustmentsResource" />
/// <reference types="stripe/types/V2/Billing/MeterEventSessionResource" />
/// <reference types="stripe/types/V2/Billing/MeterEventStreamResource" />
/// <reference types="stripe/types/V2/Billing/MeterEventsResource" />
/// <reference types="stripe/types/V2/BillingResource" />
/// <reference types="stripe/types/V2/EventTypes" />
/// <reference types="stripe/types/V2/Core/EventsResource" />
/// <reference types="stripe/types/V2/CoreResource" />
/// <reference types="stripe/types/V2Resource" />
...
/// <reference types="stripe/types/Billing/AlertTriggereds" />
/// <reference types="stripe/types/Billing/Alerts" />
/// <reference types="stripe/types/Billing/CreditBalanceSummary" />
/// <reference types="stripe/types/Billing/CreditBalanceTransactions" />
/// <reference types="stripe/types/Billing/CreditGrants" />
...
/// <reference types="stripe/types/InvoiceRenderingTemplates" />
...
/// <reference types="stripe/types/V2/Billing/MeterEventAdjustments" />
/// <reference types="stripe/types/V2/Billing/MeterEventSessions" />
/// <reference types="stripe/types/V2/Billing/MeterEvents" />
/// <reference types="stripe/types/V2/Events" />
